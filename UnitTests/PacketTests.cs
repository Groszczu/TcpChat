...
namespace UnitTests
{
    public class PacketTests
    {
        ...
        public void Packet_Should_Serialize_Correctly()
        {
            ...
            const string expected = "id-)00000000-0000-0000-0000-000000000000(|operation-)AcceptInvite(|status-)Ok(|length-)8(|message-)Accepted(|";
        ...
        {
            var inputString = "status-)Unauthorized(|operation-)AcceptInvite(|id-)10400050-5006-0070-0809-000060000000(|length-)12(|message-)Hello world!(|";
